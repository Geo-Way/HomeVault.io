...
let categoriasExtra = [];
let rutaActualCarpeta = ""; // Vacío significa la raíz principal
...
const trads = {
    de: {
        ...
        newCatOption: "➕ Neuen Ordner erstellen...",
    ...
    es: {
        ...
        newCatOption: "➕ Crear nueva carpeta...",
...
function abrirModalCategoria() {
    ...
    request.onsuccess = function() {
        const docs = request.result;
        const categoriasSet = new Set();
        categoriasSet.add(trads[idiomaActual].defaultCategory);
        ...
        Array.from(categoriasSet).sort((a, b) => a.localeCompare(b)).forEach(cat => {
            const opt = document.createElement('option');
            opt.value = cat;
            opt.innerText = cat;
...
function abrirPantallaGestion() {
    ...
    rutaActualCarpeta = ""; // Empezar en la raíz
    cargarExplorador();
}
...
function cargarExplorador() {
    ...
    request.onsuccess = function() {
        ...
        // Configurar título y miga de pan según la ruta actual
        ...
        // Recopilar todas las categorías existentes y añadidas
        ...
        // Descubrir subcarpetas y documentos directos de esta ruta
        ...
        // 1. Mostrar Subcarpetas ordenadas
        ...
        // 2. Mostrar Documentos de esta carpeta
